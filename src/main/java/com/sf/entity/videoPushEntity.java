...
public class videoPushEntity {
   public videoPushEntity(videoEntity video,String userName){
        this.setVideoID(video.getVideoID());
        this.setIscheck(video.getIscheck());
        this.setUserMingzi(userName);
        this.ispass=video.getIspass();
        this.uploadtime=video.getUploadtime();
        this.videoAddress=video.getVideoAddress();
        this.videodetail=video.getVideodetail();
        this.videocAtegory= video.getVideocAtegory();
        this.videolookTime=video.getVideolookTime();
        this.videoName=video.getVideoName();
        this.videoCollection=video.getVideoCollection();
        this.videoLeaving=video.getVideoLeaving();
        this.user_id=video.getUser_id();
        this.videoImage=video.getVideoImage();
        this.videoTime=video.getVideoTime();
        this.supportcount=video.getSupportcount();
        this.videoState=video.getVideoState();
    }
