...
public class UserListServiceImpl implements UserListService {
	...
	@Override
	public userEntity userseachByUserid(String user_id) {
		List<userEntity> userlist=userListDaoImpl.userlistUserid(user_id);
	...
	public List<videoEntity> videolistimi8MAD(int videotype) {
		return userListDaoImpl.videolistimi8MAD(videotype);
	}
