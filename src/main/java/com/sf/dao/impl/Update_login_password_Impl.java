...
/*		System.out.println(user.getUserID());
	...
	@Override
	public int Update_info(String userMingzi, String sex, String showme,String user_id) {
		String sql="update  user set userMingzi = ? ,usersex = ? , showme = ?  where userID = ?";
		int bl = jdbcTemplate.getJdbcTemplate().update(sql,new Object[]{userMingzi,sex,showme,user_id});
		return bl;
	}
