			...
			<div class="mainCont clearfix" id="dance" js-move="true">
				<div class="pic-list fl" js-tab="true">
					<div class="pic-list__title">
						...
						<h2>搜索结果</h2>
						<div class="tab-title">
							<a href="#" class="cur">一共${count}条结果</a>

						</div>

						<div class="more-wrap">
							<a href="#" class="dynamic" id="shuaxin"><i></i></a>
