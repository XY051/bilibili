...
<div class="centers_m">
	...
	<div class="centers_ml">
		...
		<div class="centers_listm">
			...
			<span class="gjszmdm"> <a href="userfollow.sf?user_id=${user.userID}" class="center_in_self"><font>关注的人</font></a>
	...
	<div class="centers_mr">
		<h1 class="welcom_tm">
			欢迎您，超级会员 <font>${user.userMingzi}</font>
		...
		<div class="public_m1">
			...
			<form action="/bilibili/updateinfo.sf" method="post">
			<div class="public_m4">
				<p>
					<em>昵称:  </em> <input type="text" name="userMingzi"
											style="margin-left:30px;height: 23px; border: 1px solid #eaeaea; width: 140px"
											value="${user.userMingzi}" >
				</p>
				<p>
					<em>性别:  </em> <input type="text" name="sex"
										  style="margin-left:30px;height: 23px; border: 1px solid #eaeaea; width: 140px"
										  value="${user.usersex}" >
				</p>
				<p>
					<em>个人简介:  </em>     <textarea    style="margin-left:30px;" rows="3" name="showme" id="showme" cols="50">${user.showme}</textarea>
