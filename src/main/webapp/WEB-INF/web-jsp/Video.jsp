...
</span></div></span></div><div data-v-cba1b22a="" class="item"><div data-v-7adc35f6="" data-v-cba1b22a="" class="nav-item"><div data-v-7adc35f6="" class="t"><!----><!----><a data-v-cba1b22a="" data-v-7adc35f6="" href="//message.bilibili.com/new" target="_blank"><span data-v-cba1b22a="" data-v-7adc35f6="" class="name"></span></a></div><!----><div data-v-7adc35f6="" class="i-frame" style="display: none;"><iframe data-v-7adc35f6="" src="//message.bilibili.com/pages/nav/index_new_pc_sync" frameborder="0" width="100%" height="100%"></iframe></div></div></div><div data-v-7fd0073e="" class="item"><div data-v-73e9d354="" data-v-7fd0073e="" class="nav-item"><div data-v-73e9d354="" class="t"><!----><div data-v-73e9d354="" class="bp-red-point"></div><a data-v-7fd0073e="" data-v-73e9d354="" href="//t.bilibili.com" target="_blank"><span data-v-7fd0073e="" data-v-73e9d354="" class="name"></span></a></div><!----></div></div><div data-v-59fb22a8="" class="item"><span data-v-59fb22a8=""><div role="tooltip" id="van-popover-6409" aria-hidden="true" class="van-popover van-popper van-popper-favorite" tabindex="0" style="width: 520px; display: none;"><!----> <div data-v-59fb22a8="" class="vp-container"><div data-v-59fb22a8="" class="tabs-panel"><!----></div><!----></div></div> <div data-v-59fb22a8="" class="mini-favorite van-popover__reference" aria-describedby="van-popover-6409" tabindex="0"><span data-v-59fb22a8=""><a href="/bilibili/mycollect.sf"><span data-v-59fb22a8="" class="name">收藏</span></a><!----></span></div></span></div><div data-v-ff0e1236="" class="item"><span data-v-ff0e1236=""><div role="tooltip" id="van-popover-4360" aria-hidden="true" class="van-popover van-popper van-popper-history" tabindex="0" style="width: 370px; display: none;"><!----> <div data-v-ff0e1236="" class="vp-container"><div data-v-ff0e1236="" class="tab-header"><div data-v-ff0e1236="" class="tab-item tab-item--active"></div><div data-v-ff0e1236="" class="tab-item"></div></div><div data-v-ff0e1236="" class="panel"><!----><!----></div></div></div> <div data-v-ff0e1236="" class="mini-history van-popover__reference" aria-describedby="van-popover-4360" tabindex="0"><span data-v-ff0e1236=""><span data-v-ff0e1236="" class="name"></span></span></div></span></div><div class="item"><a href="/bilibili/videoFileTop" target="_blank"><span class="name">视频投稿</span></a></div></div><div data-v-37c6f684=""><span data-v-37c6f684=""><div role="tooltip" id="van-popover-1542" aria-hidden="true" class="van-popover van-popper van-popper-upload" tabindex="0" style="width: 304px; display: none;"><!----> <div data-v-37c6f684="" class="vp-container"><a data-v-37c6f684="" href="//member.bilibili.com/v2#/upload/text/apply" target="_blank" class="upload-item"><i data-v-37c6f684="" class="bilifont bili-icon_dingdao_wenzhangtougao"></i><span data-v-37c6f684="" class="item-title">专栏投稿</span></a><a data-v-37c6f684="" href="//member.bilibili.com/v2#/upload/audio" target="_blank" class="upload-item"><i data-v-37c6f684="" class="bilifont bili-icon_dingdao_yinpintougao"></i><span data-v-37c6f684="" class="item-title">音频投稿</span></a><a data-v-37c6f684="" href="//member.bilibili.com/v2#/upload/video/frame" target="_blank" class="upload-item"><i data-v-37c6f684="" class="bilifont bili-icon_dingdao_shipintougao"></i><span data-v-37c6f684="" class="item-title">视频投稿</span></a><a data-v-37c6f684="" href="//member.bilibili.com/v2#/upload-manager/article" target="_blank" class="upload-item"><i data-v-37c6f684="" class="bilifont bili-icon_dingdao_tougaoguanli1"></i><span data-v-37c6f684="" class="item-title">投稿管理</span></a></div></div> <span data-v-37c6f684="" class="mini-upload van-popover__reference" aria-describedby="van-popover-1542" tabindex="0">
...
<div id="app" data-server-rendered="true">
    ...
    <div class="v-wrap" style="margin-left: 175px;margin-top: 20px;margin-bottom: 20px;margin-right: 177px">
        ...
        <div class="l-con">
            ...
            <div id="viewbox_report" class="video-info report-wrap-module report-scroll-module"><!-- 视频标题位置 -->
                ...
                <div class="video-data">
                    ...
                    <span>${videoEntity.uploadtime}</span>
        ...
        <textarea id="ai-message-input"
            ...
            <c:choose>
                <c:when test="${videoEntity.ispass==1&&videoEntity.ischeck==1 }">
                ...
                <c:when test="${videoEntity.ischeck==0 }">
                    <h7 style="font-size: 20px">作品还未审核，无法观看</h7>
                </c:when>
                <c:when test="${videoEntity.ispass==0&&videoEntity.ischeck==1 }">
                    视频未过审核，无法观看
                </c:when>
                <c:otherwise>
                </c:otherwise>
            ...
            <div id="v_desc" class="video-desc report-wrap-module report-scroll-module">
                ...
                <div class="info open">${videoEntity.videodetail}<a target="_blank" href=""></a>
                    大会员免费观看
                </div>
            </div>
                            ...
                            <ul id="slider" class="slider">
                                <c:forEach items="${messagelist}" var="messagelist">
                                    <li>
                                        ...
                                        <br>
                                        <p style="color: red;">留言者:<a href="/bilibili/user_info?user_id=${messagelist.messageuserID}" style="color: darkgoldenrod;text-decoration:none;">&nbsp;${messagelist.messageuserName}</a><span style="color: blue;">&nbsp;&nbsp;&nbsp;留言时间:${messagelist.messageTime}</span></p>
                                    </li>
                                </c:forEach>
                            </ul>
                        </div>
...
-->
        ...
        <div class="r-con">  <!-- 右侧部分 -->
            ...
            <div id="v_upinfo" class="up-info report-wrap-module report-scroll-module">
                ...
                <div class="u-face has-pendant"><a href="https://space.bilibili.com/207539637?spm_id_from=333.788.b_765f7570696e666f.1" target="_blank" report-id="head" class="fa"><img src="<%=request.getContextPath()%>${auth.userHand}" width="48" height="48" class="up-face"><img src="<%=request.getContextPath()%>/static/Homepage/videoPlay/static/image/tx2.png" width="80" height="80" class="pendant"><!----><i class="auth o-auth"></i></a></div>
                ...
                <div class="u-info">
                    <div class="name" style="line-height:40px;height:40px;"><!----><a href="/bilibili/user_info?user_id=${auth.userID}" target="_blank" report-id="name" class="username">${auth.userMingzi}</a><a href="/bilibili/user_info?user_id=${auth.userID}" target="_blank" class="message"><i class="van-icon-videodetails_messag"></i>他的主页</a>
                    </div><!---->
                </div>
                <div class="btn-panel"><!---->
                    <div class="default-btn follow-btn b-gz not-follow"><span><i class="van-icon-general_addto_s"></i><span class="guanzhu">
        关注 </span><span class="fensishu"></span></span><!----><!---->
                    </div>
                </div>
            </div>
                ...
                <div class="danmaku-wrap" style="background-color: white">
                    ...
                    <div class="Dplayer_danmu" style="width: 100%;">
                        <div class="Dplayer_watching" style="line-height:inherit;height:40px;background-color: #f4f4f4 ">
                            ...
                            弹幕列表<span class="danmuku_num"></span>
                        </div>
